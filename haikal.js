...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °𝐑. ??𝐙°${iphone2}` }, { quoted: doc })
}
}
break
...
"salePriceAmount1000": "10000000",
"retailerId": `© © °𝐑. 𝐒𝐙°WE ARE NOT MASTOD`,
"url": "Wa.me/6287794720797"
},
"businessOwnerJid": "6287794720797@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: m })
haikal.relayMessage(m.chat, catalog.message, { messageId: catalog.key.id })
}
